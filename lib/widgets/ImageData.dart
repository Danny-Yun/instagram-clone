...
class ImageData extends StatelessWidget {
  ...
  ImageData(this.icon, {Key? key, this.width = 65}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top: 3),
      child: Image.asset(icon, width: width! / Get.mediaQuery.devicePixelRatio),
    );
  }
}
...
class IconsPath {
  ...
  static String get logo => 'assets/images/insta-logo.png';
